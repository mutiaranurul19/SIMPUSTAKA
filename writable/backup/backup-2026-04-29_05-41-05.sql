...
INSERT INTO `detail_peminjaman` VALUES (23,23,17,1),(24,23,21,1),(25,24,17,1),(26,25,21,1),(27,25,23,1),(28,26,37,1),(29,26,40,1),(30,27,28,1),(31,27,34,1),(37,31,36,0),(38,31,37,0),(39,32,36,0),(40,32,37,0),(46,37,43,1),(58,45,29,1),(59,45,30,1);
...
INSERT INTO `kategori` VALUES (1,'Novel'),(5,'Sejarah'),(6,'Komik'),(7,'Pendidikan'),(8,'Teknologi'),(9,'Agama'),(10,'Bisnis'),(11,'Hukum'),(12,'Psikologi'),(13,'Sastra'),(14,'Kesehatan'),(15,'Sains'),(16,'Ekonomi'),(17,'Politik'),(18,'Pengembangan Diri'),(19,'Pendidikan Pancasila');
...
INSERT INTO `peminjaman` VALUES (45,34,0,'2026-04-29','2026-05-06','dikembalikan',0,0,0);
...
INSERT INTO `petugas` VALUES (1,1,'petugas'),(21,100322,'petugas');
...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=100331 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-04-28 22:41:05
