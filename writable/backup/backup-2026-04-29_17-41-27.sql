...
INSERT INTO `anggota` VALUES (28,1,'10001','Jl. Merdeka No.1','081234567890','2026-04-01'),(34,100322,'90988','Pamarisen','087654127865','0000-00-00');
...
INSERT INTO `buku_rak` VALUES (5,16,1),(6,17,1),(7,18,1),(8,20,1),(9,21,1),(10,22,1),(11,23,1),(12,24,1),(13,26,1),(14,27,11),(15,28,11),(16,29,11),(17,30,11),(18,31,11),(19,32,11),(20,33,11),(21,34,11),(22,35,11),(23,36,11),(24,37,11),(25,38,11),(26,39,11),(27,40,11),(28,41,12),(29,42,13),(30,43,17),(31,44,9);
...
INSERT INTO `detail_peminjaman` VALUES (23,23,17,1),(24,23,21,1),(25,24,17,1),(26,25,21,1),(27,25,23,1),(28,26,37,1),(29,26,40,1),(30,27,28,1),(31,27,34,1),(37,31,36,0),(38,31,37,0),(39,32,36,0),(40,32,37,0),(46,37,43,1),(58,45,29,1),(59,45,30,1),(60,46,37,1);
...
INSERT INTO `kategori` VALUES (1,'Novel'),(5,'Sejarah'),(6,'Komik'),(7,'Pendidikan'),(8,'Teknologi'),(9,'Agama'),(10,'Bisnis'),(11,'Hukum'),(12,'Psikologi'),(13,'Sastra'),(14,'Kesehatan'),(15,'Sains'),(16,'Ekonomi'),(17,'Politik'),(18,'Pengembangan Diri'),(19,'Pendidikan Pancasila'),(20,'Bahasa Sunda');
...
CREATE TABLE `peminjaman` (
  ...
  `jumlah_perpanjang` int(11) NOT NULL,
...
INSERT INTO `peminjaman` VALUES (45,34,0,'2026-04-29','2026-05-06','dikembalikan',0,0,0),(46,34,0,'2026-04-29','2026-05-06','dipinjam',0,0,0);
...
INSERT INTO `pengembalian` VALUES (25,45,'2026-04-29',0.00,'Tepat Waktu');
...
INSERT INTO `petugas` VALUES (23,100322,'petugas'),(24,1,'admin');
...
INSERT INTO `rak` VALUES (9,'Rak A1','Lantai 1 -  Dekat Jendela'),(10,'Rak A2','Lantai 1 - Sebelah Resepsionis'),(11,'Rak B1','Lantai 1 - Area Novel'),(12,'Rak B2','Lantai 1 - Area Sejarah'),(13,'Rak C1','Lantai 2 - Area Teknologi'),(14,'Rak C2','Lantai 2 - Area Pemrograman'),(15,'Rak D1','Lantai 2 - Area Psikologi'),(16,'Rak D2','Lantai 2 - Area Filosofi'),(17,'Rak E1','Lantai 3 - Area Referensi'),(18,'Rak E2','Lantai 3 - Gudang Buku'),(19,'Rak F2','Lantai 2 - Dekat Reservasi');
...
INSERT INTO `ulasan` VALUES (1,18,2026,3,'bagus','2026-04-22 09:28:39'),(2,18,191207,5,'SERUUUU','2026-04-22 09:35:26'),(3,28,123,1,'sesuai','2026-04-26 07:12:47');
...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=100334 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'Mutiara Nurul','mutiara.nurul1474@smk.belajar.id','Mutiara Nurul','$2y$10$FMQRdH0ecCbZZVWtN2n7/u1YZN/gr7X98Er4NG4sqDAWCXlZwmB6S','admin','1777227731_1ecc3db9c4bec07c0cc0.jpg','aktif'),(100322,'Rika ','rika.apriliani85@smk.belajar.id','Rika Apriliani','$2y$10$W9fygBOQYuy8AZNlqic7J.1PyIve87n3JDyeZpAy4ShJboI/e53b.','petugas','1777227831_6dff157c7eac4abdf676.jpg','aktif'),(100330,'Iis Sadiyah','iis.sadiyah7@smk.belajar.id','iis','$2y$10$0Sfrz8aDsRzGzm2en8.mie0PxeoDh36nDIbiPgXQH7qHuhRPR7EXK','anggota','1777483509_9fb71936846b81ccdee2.png','aktif'),(100333,'aliya','aliyarabitha@gmail.com','aliya','$2y$10$fzcvKq8XA/32hnUgGR4jEOeU2/rA.wCeeNRT6NALMUfOIt3fgy5b2','anggota','1777483552_5836109bb63e47bf13d0.jpg','aktif');
...
-- Dump completed on 2026-04-29 10:41:27
